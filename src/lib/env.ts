...
export const env = {
  ...
  smtpFrom:     optional("SMTP_FROM",   "Vincel Studio <noreply@vincelstudio.com>"),
  ...
  salesEmail:   optional("SALES_EMAIL", optional("SMTP_FROM", "Vincel Studio <noreply@vincelstudio.com>")),
